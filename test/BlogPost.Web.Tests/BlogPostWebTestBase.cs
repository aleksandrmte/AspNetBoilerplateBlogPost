...
{
    public abstract class BlogPostWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BlogPostWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BlogPostWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BlogPostDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BlogPostDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BlogPostDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BlogPostDbContext, Task<T>> func)
        {
            T result;
